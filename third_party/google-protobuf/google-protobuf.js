...
function ta(a, b, c) {
  for (var d = [], f = 2; f < arguments.length; ++f) d[f - 2] = arguments[f];
  "string" !== typeof a &&
    sa("Expected string but got %s: %s.", [k(a), a], b, d);
}
function ua(a, b, c) {
  for (var d = [], f = 2; f < arguments.length; ++f) d[f - 2] = arguments[f];
...
function q(a, b, c, d) {
  ...
  a instanceof b ||
    sa("Expected instanceof %s but got %s.", [va(b), va(a)], c, f);
}
function va(a) {
...
r.deserializeBinary = function (a, b, c, d, f, h, m) {
  for (; b.oa() && !b.bb(); ) {
    ...
    1 == t
      ? (h = c.call(b))
      : 2 == t &&
        (a.b ? (n(f), m || (m = new a.b()), d.call(b, m, f)) : (m = d.call(b)));
  }
  n(void 0 != h);
  n(void 0 != m);
  a.set(h, m);
...
function Ea(a, b) {
  ...
  for (var d = 0; ; ) {
    ...
    b((f << 2) | (h >> 4));
    64 != m &&
      (b(((h << 4) & 240) | (m >> 2)), 64 != t && b(((m << 6) & 192) | t));
  }
}
function Ca() {
  if (!x) {
...
g(
  ...
  function (a) {
    ...
    for (var b = "", c = 0; 8 > c; c++)
      b =
        String.fromCharCode(
          16 * Sa(a.charCodeAt(2 * c + 2)) + Sa(a.charCodeAt(2 * c + 3))
        ) + b;
    return b;
  },
  void 0
...
I.prototype.w = function (a) {
  ...
  128 <= b &&
    ((b = this.b[this.a++]), (c |= (b & 127) << 28), (d |= (b & 127) >> 4));
  if (128 <= b)
    for (f = 0; 5 > f && 128 <= b; f++)
...
I.prototype.fa = function (a) {
  ...
  for (var d = [], f = ""; c < a; ) {
    ...
    8192 <= d.length &&
      ((f += String.fromCharCode.apply(null, d)), (d.length = 0));
  }
  f += xa(d);
  this.a = c;
  return f;
...
J.prototype.oa = function () {
  ...
  if (0 != a && 5 != a && 1 != a && 2 != a && 3 != a && 4 != a)
    return (
      p("Invalid wire type: %s (at position %s)", a, this.O), (this.h = !0), !1
    );
  this.c = b;
  this.b = a;
  return !0;
...
J.prototype.lb = function () {
  0 != this.b
    ? (p("Invalid wire type for skipVarintField"), this.C())
    : this.a.kb();
};
...
J.prototype.hb = function () {
  5 != this.b
    ? (p("Invalid wire type for skipFixed32Field"), this.C())
    : this.a.advance(4);
};
J.prototype.skipFixed32Field = J.prototype.hb;
J.prototype.ib = function () {
  1 != this.b
    ? (p("Invalid wire type for skipFixed64Field"), this.C())
    : this.a.advance(8);
};
...
N.initialize = function (a, b, c, d, f, h) {
  ...
  a: {
    ...
    -1 < d
      ? ((a.G = Math.max(d, b + 1 - a.D)), (a.i = null))
...
N.addToRepeatedWrapperField = function (a, b, c, d, f) {
  ...
  a = O(a, b);
  void 0 != f
    ? (h.splice(f, 0, c), a.splice(f, 0, c.g()))
    : (h.push(c), a.push(c.g()));
  return c;
};
...
N.prototype.getExtension = function (a) {
  if (this.i) {
    ...
    if (a.na) {
      ...
      return (
        !this.f[b] && this.i[b] && (this.f[b] = new a.la(this.i[b])), this.f[b]
      );
    return this.i[b];
  }
};
...
N.equals = function (a, b) {
  return (
    a == b || (!(!a || !b) && a instanceof b.constructor && nb(a.g(), b.g()))
  );
};
function ob(a, b) {
  a = a || {};
...
N.copyInto = function (a, b) {
  ...
  a = pb(a);
  for (var c = b.g(), d = a.g(), f = (c.length = 0); f < d.length; f++)
    c[f] = d[f];
  b.f = a.f;
  b.i = a.i;
};
...
W.prototype.ab = function () {
  n(0 == this.h.length);
  for (
    var a = new Uint8Array(this.b + this.a.length()),
      b = this.c,
      c = b.length,
      d = 0,
      f = 0;
...
W.prototype.Qa = function (a, b) {
  null != b &&
    (n(0 <= b && 1.8446744073709552e19 > b), Y(this, a, 1), this.a.V(b));
};
...
W.prototype.Ra = function (a, b) {
  null != b &&
    (n(-2147483648 <= b && 2147483648 > b), Y(this, a, 5), this.a.S(b));
};
...
W.prototype.I = function (a, b) {
  null != b &&
    (n("boolean" === typeof b || "number" === typeof b),
    Y(this, a, 0),
    this.a.I(b));
};
...
W.prototype.R = function (a, b) {
  null != b &&
    (n(-2147483648 <= b && 2147483648 > b), Y(this, a, 0), this.a.M(b));
};
...
W.prototype.Sd = function (a, b, c, d) {
  if (null != b)
    for (var f = 0; f < b.length; f++) this.tb(a, c(b[f]), d(b[f]));
};
